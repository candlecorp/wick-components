...
pub(crate) struct Config {
    pub(crate) dim: usize,        // transformer dimension
    pub(crate) hidden_dim: usize, // for ffn layers
    pub(crate) n_layers: usize,   // number of layers
    pub(crate) n_heads: usize,    // number of query heads
    pub(crate) n_kv_heads: usize, // number of key/value heads (can be < query heads because of multiquery)
    pub(crate) vocab_size: usize, // vocabulary size, usually 256 (byte-level)
    pub(crate) seq_len: usize,    // max sequence length
